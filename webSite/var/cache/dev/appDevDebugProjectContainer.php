...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_6b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5c' => 'get16b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5cService',
            '2_6b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5c' => 'get26b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5cService',
        ...
        $this->privates = array(
            '1_6b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5c' => true,
            '2_6b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5c' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_6b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5c']) ? $this->services['1_6b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5c'] : $this->get16b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5cService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_6b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5c']) ? $this->services['2_6b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5c'] : $this->get26b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5cService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'medicalsoft', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\menuBundle\\Resources\\config\\doctrine') => 'menuBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'menuBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('menuBundle' => 'menuBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_f8d947605b1be68b25dbd0a2bbd923536f200a9ccb28c2909b6bff5b7c83cf17');
    ...
    protected function getForm_RegistryService()
    {
        ...
        }, 'menuBundle\\Form\\Type\\RegistrationFormType' => function () {
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('menuBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.group.form.type'] = new \FOS\UserBundle\Form\Type\GroupFormType('menuBundle\\Entity\\Grupo');
    }
    ...
    {
        return $this->services['fos_user.group_manager'] = new \FOS\UserBundle\Doctrine\GroupManager(${($_ = isset($this->services['fos_user.object_manager']) ? $this->services['fos_user.object_manager'] : $this->getFosUser_ObjectManagerService()) && false ?: '_'}, 'menuBundle\\Entity\\Grupo');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('menuBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory(${($_ = isset($this->services['form.factory']) ? $this->services['form.factory'] : $this->get('form.factory')) && false ?: '_'}, 'fos_user_registration_form', 'menuBundle\\Form\\Type\\RegistrationFormType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('menuBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('menuBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager(${($_ = isset($this->services['fos_user.util.password_updater']) ? $this->services['fos_user.util.password_updater'] : $this->getFosUser_Util_PasswordUpdaterService()) && false ?: '_'}, ${($_ = isset($this->services['fos_user.util.canonical_fields_updater']) ? $this->services['fos_user.util.canonical_fields_updater'] : $this->getFosUser_Util_CanonicalFieldsUpdaterService()) && false ?: '_'}, ${($_ = isset($this->services['fos_user.object_manager']) ? $this->services['fos_user.object_manager'] : $this->getFosUser_ObjectManagerService()) && false ?: '_'}, 'menuBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/inicio');
        ...
        $o->setOptions(array('default_target_path' => 'menu_homepage', 'always_use_default_target_path' => true, 'use_referer' => true, 'target_path_parameter' => 'go_to', 'login_path' => '/login'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\menuBundle/Resources/views'), 'FOSUser');
    ...
    /**
     * Gets the private '1_6b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5c' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get16b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5cService()
    {
        return $this->services['1_6b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5c'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_6b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5c' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get26b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5cService()
    {
        return $this->services['2_6b3d3c0daff3b337476be92012d865ed9fcaa9dd6c39359982512baacb714b5c'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
     ...
     *
     * @return \menuBundle\Form\Type\RegistrationFormType
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \menuBundle\Form\Type\RegistrationFormType();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('k96XbUzX3h', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BJQKKYxLGY', 0, 'W31Niwb6o1YX9dU-IdFCUp', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('poPhvj6oAD', 0, 'W31Niwb6o1YX9dU-IdFCUp', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vVrgCU6Q0a', 0, 'W31Niwb6o1YX9dU-IdFCUp', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a2b612b8af682.14894653');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_user.model.user.class' => 'menuBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'santyr10@hotmail.com' => 'Demo String',
            ),
            'fos_user.registration.confirmation.enabled' => false,
            'fos_user.registration.form.type' => 'menuBundle\\Form\\Type\\RegistrationFormType',
            ...
            'fos_user.model.group.class' => 'menuBundle\\Entity\\Grupo',
